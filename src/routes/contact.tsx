          ...
          <div>
            ...
            <div className="mt-8 border border-border bg-card p-6 shadow-sm space-y-5">
              ...
              <div className="border-t border-border pt-4">
                ...
                <a href={`mailto:${email}`} className="mt-1 inline-flex max-w-full items-center gap-2 text-sm font-semibold text-pharma hover:underline break-all">
                  <Mail className="size-4 shrink-0" /> <span className="break-all">{email}</span>
                </a>
              </div>
